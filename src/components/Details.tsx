...
import { Info, Map as MapIcon, Utensils, Shirt } from "lucide-react";
    ...
    return (
        <section className="py-24 bg-ivory text-navy px-4">
            <div className="max-w-6xl mx-auto">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-serif italic text-gold">Informations Utiles</h2>
                </motion.div>
...
function DetailCard({
    ...
    return (
        ...
        >
            <div className="p-3 bg-ivory rounded-full text-gold">
                {icon}
            </div>
