          ...
          >
            ...
            >
              ...
              <p className="text-navy/80 font-sans">
                Votre réponse a bien été enregistrée. Nous avons hâte de vous
                retrouver.
              </p>
            </motion.div>
          </motion.div>
          ...
          <div className="w-full max-w-2xl mx-auto bg-white text-navy p-6 md:p-10 rounded-2xl shadow-xl border border-gold/20">
            <form onSubmit={handleSubmit} className="space-y-8 text-left">
              ...
              <div className="space-y-3">
                <label className="block text-navy font-serif text-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <span className="font-sans text-sm text-center">
                      Oui, je confirme ma présence pour votre grand jour !
                    </span>
                  </label>
                  <label
                    className={`
                  ...
                  >
                    <div className="space-y-4 pt-4 border-t border-gray-100">
                      ...
                      {formData.hasChildren === "oui" && (
                        ...
                        >
                          <label className="font-sans text-navy/80">
                            Nombre d&apos;enfants :
                          </label>
