...
const events = [
    ...
    },
    {
        ...
        description: "Rafraîchissements et musique traditionnelle en attendant la mariée.",
    ...
    },
    {
        ...
        description: "Cena y celebración - Un festin royal pour célébrer notre union.",
